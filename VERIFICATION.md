...
The refreshed hosted GitHub Pages page was reviewed in Chromium after commit `acee4c278b8fe8e65ea8b284254802d5050a748b`, using a 1,363 × 936 browser viewport. These are browser layout checks, not physical-device tests.
